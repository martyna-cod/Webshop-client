...
import { pickCategory } from '../actions/products';
			...
			<Nav className="justify-content-center" activeKey="/home">
				<div className="navbar-links">
					...
					<Dropdown>
						<Dropdown.Toggle
							variant="secondary"
							style={{ padding: '5px', height: '40px', width: '100px', color: 'black' }}
						>
							Women
						</Dropdown.Toggle>
							...
							{props.category &&
								props.category.map((category) => {
									return (
										<Dropdown.Item>
											<Nav key={category.id} 
											onClick={() => props.pickCategory(category.id)}>{category.name} </Nav>
										</Dropdown.Item>
									);
								})}
						</Dropdown.Menu>
...
export default connect(null, { pickCategory })(NavBar);
