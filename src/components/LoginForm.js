...
export default function LoginForm(props) {
	return (
		...
		<Form  onSubmit={props.onSubmit}>
			...
			<Button style={{backgroundColor: "#E50914",fontFamily: "'Anton', sans-serif", height: "35px", padding: "2.5px" }} type="Submit" className="btn-lg btn-dark btn-block">Log in</Button>

			<Form.Text style={{marginTop: "12px", color: "white"}} className="text-center">
				New to our webshop?    
				<Link style={{fontFamily: "'Anton', sans-serif", fontSize: "15px", color: "#3D72A4" }}to="/sign-up">      Sign up now</Link> <br />
			</Form.Text>
		</Form>
		</div>
		</div>
